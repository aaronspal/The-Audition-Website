...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oa(e,t,n){let r=new Float32Array(ma),i=new q(0,1,0);return new ci({name:`SphericalGaussianBlur`,defines:{n:ma,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ja(),fragmentShader:`
	...
	`}var Ma=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Jr([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `,transparent:!0}),u=new Ir(new $r(2,2),l);s.add(u);let d=()=>{let e=a.parentElement,t=e.offsetWidth,n=e.offsetHeight;r.width=t,r.height=n,o.setSize(t,n)};d();let f=()=>{let e=i.createImageData(r.width,r.height),t=e.data;for(let e=0;e<r.height;e+=2)for(let n=0;n<r.width;n+=2){let i=Math.random()*255;for(let a=0;a<2&&e+a<r.height;a++)for(let o=0;o<2&&n+o<r.width;o++){let s=((e+a)*r.width+(n+o))*4;t[s]=i,t[s+1]=i,t[s+2]=i,t[s+3]=15}}return e},p=0,m=0,h=()=>{let e=Date.now();e-p>200&&(i.putImageData(f(),0,0),p=e),m+=.05,l.uniforms.time.value=m,o.render(s,c),n.current=requestAnimationFrame(h)};return h(),window.addEventListener(`resize`,d),()=>{window.removeEventListener(`resize`,d),cancelAnimationFrame(n.current),o.dispose(),s.remove(u),u.geometry.dispose(),u.material.dispose()}},[]),(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`canvas`,{ref:e,className:`crtCanvas crtNoise`}),(0,$.jsx)(`canvas`,{ref:t,className:`crtCanvas crtScanlines`})]})}function yc(){let[e,t]=(0,o.useState)(3132849),[r,i]=(0,o.useState)(!1),a=(0,o.useCallback)(()=>{let e=(Math.random()*9+1)*1e3;return setTimeout(()=>{t(e=>e+1),i(!0),setTimeout(()=>i(!1),300),a()},e)},[]);return(0,o.useEffect)(()=>{let e=a();return()=>clearTimeout(e)},[a]),(0,$.jsxs)(`section`,{className:`hero`,style:{backgroundImage:`url(${s})`},children:[(0,$.jsx)(`div`,{className:`heroOverlay`,children:(0,$.jsxs)(`div`,{className:`container flexColumn textCenter heroContent`,children:[(0,$.jsxs)(`div`,{className:`heroCenter`,children:[(0,$.jsx)(`div`,{className:`heroAbove`,children:`Here lies:`}),(0,$.jsx)(`div`,{className:`glitchEffect heroH1`,children:(0,$.jsx)(`h1`,{className:`black${r?` ticking`:``}`,children:e.toLocaleString()})}),(0,$.jsxs)(`div`,{className:`heroBelow`,children:[(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`span`,{className:`whiteText`,children:`executed contestants.`}),` Will you be next?`]}),(0,$.jsx)(`div`,{className:`zIndex10 heroCTA`,children:(0,$.jsx)(n,{href:`/download`,children:`Play Itch Preview`})})]})]}),(0,$.jsx)(`p`,{className:`heroDisclaimer monoText`,children:`By clicking "Play" the Contestant consents to their own execution as determined by the Investors.`})]})}),(0,$.jsx)(vc,{})]})}function bc({image:e,alt:t,title:n,category:i,date:a,description:o,to:s}){let c=(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`tornEdge`,children:(0,$.jsx)(`img`,{src:e,alt:t,className:`newsCardImage`})}),(0,$.jsx)(`div`,{className:`newsCardMeta monoText`,children:(0,$.jsx)(`span`,{className:`newsCardDate`,children:a})}),(0,$.jsx)(`h3`,{className:`newsCardTitle`,children:n}),(0,$.jsx)(`p`,{className:`newsCardDescription`,children:o})]});return s?(0,$.jsx)(r,{to:s,className:`newsCard flex1`,children:c}):(0,$.jsx)(`div`,{className:`newsCard flex1`,children:c})}var xc=[{name:`Marigold`,serial:`41927`,date:`12-MAR-2026`,status:`decommissioned`},{name:`Atlas`,serial:`08851`,date:`04-APR-2026`,status:`renewed`},{name:`Penelope`,serial:`00614`,date:`18-APR-2026`,status:`active`},{name:`Zephyr`,serial:`13302`,date:`22-FEB-2026`,status:`replaced`},{name:`Carmen`,serial:`20188`,date:`09-APR-2026`,status:`active`},{name:`Vega`,serial:`04473`,date:`27-JAN-2026`,status:`decommissioned`},{name:`Lou`,serial:`35540`,date:`15-APR-2026`,status:`active`},{name:`Orion`,serial:`09926`,date:`01-APR-2026`,status:`renewed`}];function Sc({stars:e=xc,eyebrow:t=`The Audition · Roll Call`,title:n=`Recent Superstars`,subtitle:r=`Honoring those who the investors most adored`}){return(0,$.jsxs)(`section`,{className:`recentSuperstars`,children:[(0,$.jsxs)(`div`,{className:`superStarHeader paperBackground textCenter`,children:[(0,$.jsx)(`div`,{className:`superStarEyebrow monoText greenInkText`,children:t}),(0,$.jsx)(`h2`,{className:`titleFont colorBlack`,children:n}),(0,$.jsx)(`div`,{className:`superStarSub monoText greenInkText`,children:r})]}),(0,$.jsx)(`div`,{className:`superStarBoard`,children:e.map((e,t)=>(0,$.jsxs)(`div`,{className:`superStarCard paperBackground textCenter`,"data-status":e.status,children:[(0,$.jsx)(`div`,{className:`superStarName colorBlack`,children:e.name}),(0,$.jsx)(`div`,{className:`superStarDate monoText greenInkText`,children:e.date}),(0,$.jsx)(`div`,{className:`superStarStamp monoText`,children:e.serial})]},e.serial+`-`+t))})]})}function Cc({doors:e,title:t=`Connect With Us`,signoffLeft:n=`Filed · The Field Studios`,signoffRight:r}={}){return r||``+new Date().toLocaleDateString(`en-GB`).replace(/\//g,`-`),(0,$.jsxs)(`div`,{className:`playbill paperBackground`,children:[(0,$.jsx)(`div`,{className:`bloodTl`}),(0,$.jsx)(`h1`,{className:`textCenter colorBlack`,children:t}),(0,$.jsx)(`div`,{className:`flexContainer flex1 playbillDoors`,children:(e||[{num:`No. 01`,name:`Discord`,label:`The Pit`,icon:`/assets/Discord-BhVv9-n2.png`,href:`#`},{num:`No. 02`,name:`Instagram`,label:`Stage Doors`,icon:`/assets/Instagram-B7oBoZh4.png`,href:`#`},{num:`No. 03`,name:`TikTok`,label:`Dispatches`,icon:`/assets/TikTok-Bk3fBpLe.png`,href:`#`},{num:`No. 04`,name:`Steam`,label:`Wishlist`,icon:`/assets/Steam-BrDRMUZC.png`,href:`#`}]).map((e,t)=>(0,$.jsxs)(`a`,{className:`playbillDoor`,href:e.href||`#`,children:[(0,$.jsx)(`div`,{className:`playbillDoorNum`,children:e.num||`No. `+String(t+1).padStart(2,`0`)}),(0,$.jsx)(`img`,{src:e.icon,className:`playbillDoorIcon`,alt:``}),(0,$.jsx)(`div`,{className:`playbillDoorName`,children:e.name}),(0,$.jsx)(`div`,{className:`playbillDoorLabel`,children:e.label})]},t))})]})}var wc=`/assets/poster-BtmR-ITH.png`,Tc=`/assets/news2-L-c-mDKf.png`,Ec=`/assets/news3-KtKy40GS.png`,Dc=`/assets/gameplay-CY6viW59.gif`;function Oc(){return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(yc,{}),(0,$.jsx)(`div`,{className:`container homeAbout`,children:(0,$.jsxs)(`div`,{className:`flexContainer g50 alignCenter`,children:[(0,$.jsx)(`div`,{className:`w60`,children:(0,$.jsxs)(`div`,{className:`w90`,children:[(0,$.jsx)(`h2`,{className:`titleFont marginBottom`,children:`Calling All Superstars`}),(0,$.jsx)(`p`,{children:`The Audition is a music-based psychological horror game where you participate in a deadly contest to become the world's next SUPERSTAR.`}),(0,$.jsx)(`br`,{}),(0,$.jsx)(`p`,{children:`You must navigate through a cruel and unforgiving industrialized dystopian world to survive. You've always dreamed of making it big in the music industry and your passion drives you, but passion alone will not please the investors. As you navigate the world, you will be faced with questions you cannot answer, but diligence is rewarded, and nothing is a coincidence.`}),(0,$.jsx)(`br`,{}),(0,$.jsx)(`p`,{children:`Becoming the world's next SUPERSTAR is no easy task. To achieve your dreams, you must prove you are worthy in a 1v1 guitar duel. Use your keyboard's rows as guitar strings, freestyle a performance to show that you are a valuable asset, and endure the investor's mysterious criteria for success.`}),`Read more about the game`]})}),(0,$.jsx)(`div`,{className:`w40 imageDistorted tornEdge`,children:(0,$.jsx)(`img`,{src:wc,alt:`The Audition poster`,className:`image100`})})]})}),(0,$.jsxs)(`div`,{className:`container textCenter homeGameplay`,children:[(0,$.jsx)(`h1`,{className:`marginBottom`,children:`Failure Is an Option`}),(0,$.jsx)(`p`,{className:`monoText`,children:`A battle to the death always includes blood, toil, tears, and sweat`}),(0,$.jsx)(`div`,{className:`tornEdge lowZIndex`,children:(0,$.jsx)(`img`,{src:Dc,alt:`Gameplay preview`,className:`image100`})})]}),(0,$.jsx)(Sc,{}),(0,$.jsxs)(`div`,{className:`container homeDevDiary`,children:[(0,$.jsx)(`h2`,{className:`textCenter titleFont`,children:`News`}),(0,$.jsxs)(`section`,{className:`flexContainer flexGrow g20`,children:[(0,$.jsx)(bc,{image:a,alt:`Developer diary 1`,title:`Developer Diary 1`,category:`Dev Diary`,date:`April 14th 2026`,description:`A behind-the-scenes look at the making of The Audition.`,to:`/dev-diary-1`}),(0,$.jsx)(bc,{image:Tc,alt:`Developer diary 2`,title:`Developer Diary 2`,category:`Dev Diary`,date:`April 14th 2026`,description:`A behind-the-scenes look at the making of The Audition.`}),(0,$.jsx)(bc,{image:Ec,alt:`Developer diary 3`,title:`Developer Diary 3`,category:`Dev Diary`,date:`April 14th 2026`,description:`A behind-the-scenes look at the making of your mom`})]})]}),(0,$.jsx)(Cc,{})]})}export{Oc as Component};